...
// import removeServerFromDirname from '../util/removeServerfromDirname';
...
const sitemap = sm.createSitemap({
  ...
  hostname: 'https://kandelborg.dk/',
});

const sitemapSWAndRobots = ({ router, app }: { router: Router | Express; app: any }) => {
  sitemap.add({
    changefreq: 'daily',
    priority: 1,
    url: '/',
